...
if __name__ == '__main__':
    ...
    def simulate_updates():
        updates = [
            {'type': 'start', 'project': 'Project Alpha', 'path': '/remote/alpha'},
            {'type': 'progress', 'project': 'Project Alpha', 'path': '/remote/alpha', 'percentage': 30},
            {'type': 'start', 'project': 'Project Beta', 'path': '/remote/beta'},
            {'type': 'progress', 'project': 'Project Alpha', 'path': '/remote/alpha', 'percentage': 75},
            {'type': 'progress', 'project': 'Project Beta', 'path': '/remote/beta', 'percentage': 50},
            {'type': 'end', 'project': 'Project Alpha', 'path': '/remote/alpha', 'success': True},
            {'type': 'progress', 'project': 'Project Beta', 'path': '/remote/beta', 'percentage': 90},
            {'type': 'end', 'project': 'Project Beta', 'path': '/remote/beta', 'success': False, 'error': 'rsync error code 12'},
            {'type': 'start', 'project': 'Project Gamma', 'path': '/remote/gamma'},
            {'type': 'end', 'project': 'Project Gamma', 'path': '/remote/gamma', 'success': True},
        ]
        for i, update in enumerate(updates):
            QTimer.singleShot(i * 1000, lambda u=update: panel.update_status(u)) # Use lambda to capture update correctly

    # Use a QTimer to start the simulation after the event loop starts
    QTimer.singleShot(500, simulate_updates)
